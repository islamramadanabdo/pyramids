<%-- 
    Document   : updateroom
    Created on : Jan 12, 2021, 6:00:36 PM
    Author     : Ahmed
--%>
...
<html>
    ...
    <body>
        ...
        <form action="updateroom">
            ...
            <input type="text" name="roomId" required="true" placeholder="Enter Room Id">
            <p>Enter Room Adults Number:</p>
            <input type="text" name="adultsNum" required="true" placeholder="Adults Number">
            <p>Enter Room Children Number:</p>
            <input type="text" name="childrenNum" required="true" placeholder="Children Number">
            <p>Enter Room Price:</p>
            <input type="text" name="price" required="true" placeholder="Room Price"><br><br>
